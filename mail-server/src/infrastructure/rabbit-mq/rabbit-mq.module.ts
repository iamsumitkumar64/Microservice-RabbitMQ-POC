...
import { FollowCreatedConsumer } from './consumers/user/follow-created/follow-created.consumer';
import { FollowDeletedConsumer } from './consumers/user/follow-deleted/follow-deleted.consumer';
